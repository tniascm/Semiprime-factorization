...
These 14 Rust crates implement factoring approaches that are NOT poly(log N).
...
| `alpha-evolve` | 2603 | Heuristic | Evolutionary search: population of factoring strategies with fitness-driven mutation |
